...
int main() {
    ...
    Camera cam(lookfrom, lookat, 2, 20, aspect_ratio,dist_to_focus );
    const int image_width = 1280;
    const int image_height = static_cast<int>(image_width / cam.getAspectRatio());
    ...
    auto material_right  = std::make_shared<PerfectReflection>(Color (0.8, 0.6, 0.2), 0.0);
